...
class ProjectCrystallizer:
    ...
    def crystallize(self):
        ...
        print("✅ [CRISTALIZADOR] Projeto cicatrizado e pronto para o Nexus.")
    ...
    def _fix_file_structure(self, file_path, file_id):
        ...
        # Verifica se a classe correta já existe
        if f"class {expected_class}" in content:
            return

        print(f"  [🔧] Corrigindo estrutura: {file_id}.py -> class {expected_class}")
