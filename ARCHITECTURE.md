...
graph LR
    ...
    app_adapters["<b>adapters</b><br/><hr/>📄 macrodroid_adapter.py: MacroDroidAdapter, execute<br/>📄 voice_adapter.py: VoiceAdapter, stt"]
