...
print()
print("   Example:")
print('   - Issue mentions "readme" → auto-detects README.md')
print('   - Issue mentions "requirements" → auto-detects requirements.txt')
...
print("   ❌ CRITICAL: No AI API keys found!")
...
print()
print("   Example:")
print('   - Issue: "adicionar uma seção sobre instalação ao README"')
...
print()
print("→ Extracts file path from traceback: app/main.py")
print("→ Gets AI to fix the bug")
print("→ Creates PR with fix")
print()
...
print('python scripts/auto_fixer_logic.py')
print()
print("→ Detects documentation request")
print("→ Finds README.md (mentioned in issue)")
print("→ AI adds testing section to README")
print("→ Creates PR with update")
print()
...
print('python scripts/auto_fixer_logic.py')
print()
print("→ Detects 'readme' (lowercase)")
print("→ Maps to README.md in repository")
print("→ AI updates the file")
print("→ Creates PR")
print()
...
print('python scripts/auto_fixer_logic.py')
print()
print("→ Detects 'requirements' mention")
print("→ Maps to requirements.txt")
print("→ AI adds pytest dependency")
print("→ Creates PR")
print()
...
print()
print("  📄 Documentation:")
print("     - readme, readme.md → README.md")
print("     - contributing, contributing.md → CONTRIBUTING.md")
print("     - license, license.md → LICENSE")
print()
print("  📦 Dependencies:")
print("     - requirements, requirements.txt → requirements.txt")
print("     - setup, setup.py → setup.py")
print()
print("  🐳 Infrastructure:")
print("     - dockerfile → Dockerfile")
print("     - docker-compose, docker-compose.yml → docker-compose.yml")
print("     - makefile → Makefile")
print()
print("  🔧 Configuration:")
print("     - gitignore, .gitignore → .gitignore")
print()
...
print("="*70)
print()
print("✓ Jarvis can now update documentation, not just fix code bugs")
print("✓ Users can request file updates in natural language")
print("✓ No need to specify exact file paths in issues")
print("✓ Clear error messages when API keys are missing")
print("✓ Bilingual support (English and Portuguese)")
print()
