...
CORREÇÃO GEMINI: Adicionado threading.Lock para segurança de concorrência.
"""
import logging
...
class WorkingMemory:
    ...
    def _evict_old_entries(self, max_age_hours: int = 24) -> Tuple[List[Dict[str, Any]], int]:
        ...
        CORREÇÃO GEMINI: Todo o loop está dentro do lock.
        """
