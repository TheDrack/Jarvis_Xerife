...
class JarvisNexus:
    ...
    def resolve(self, target_id: str, hint_path: str = None, singleton: bool = True) -> Optional[Any]:
        ...
        # Se falhar ou não houver no cache, executa VARREDURA TOTAL
        if not instance:
    ...
    def commit_memory(self):
        ...
        try:
            ...
            logging.error(f"❌ Erro ao atualizar Gist: {e}")
